...
fn main() {
    ...
    let git2 = Git2::builder().branch(true).sha(true).commit_message(true).commit_timestamp(true).build();
    let rustc = Rustc::builder().channel(true).semver(true).commit_date(true).commit_hash(true).llvm_version(true).build();
